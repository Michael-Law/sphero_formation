...
from std_msgs.msg import ColorRGBA                               #Import the ColorRGBA Package from the std_msgs package
from geometry_msgs.msg import Pose, Vector3, Quaternion          #Import the Pose, Vector3 and Quaternion package from geometry_msgs package
...
class Vector3(object):
    ...
    def __str__(self):
        ...
        return "({: .3f}, {: .3f})".format(self.x, self.y, self.z)

    def __repr__(self):
        return "Vector2({0}, {1})\n\t.norm = {2}\n\t.arg = {3}".format(self.x, self.y, self.z, self.norm(), self.arg())
    ...
    def rotate(self, value):
        ...
        self.x, self.y, self.z = math.cos(value) * self.x - math.sin(value) * self.y, \
