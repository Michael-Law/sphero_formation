...
from util import Vector3, angle_diff, MAFilter
...
def get_agent_velocity(agent):
    ...
    vel.z = agent.twist.twist.linear.z
    return vel
...
def get_agent_position(agent):
    ...
    pos.z = agent.pose.pose.position.z
    return pos
...
class Boid(object):
	...
	# self.initial_velocity.linear.z = initial_velocity_z
    ...
    def compute_separation(self, nearest_agents):
        ...
        if count:
            # Divide by number of close-by agents to get average force.
            direction /= count
    ...
    def compute_avoids(self, avoids):
        ...
        """
        main_direction = Vector3()
        safety_direction = Vector3()
        count = 0
    ...
    def compute_velocity(self, my_agent, nearest_agents, avoids):
        ...
        # Normal operation, velocity is determined using Reynolds' rules.
            ...
            self.old_velocity = Vector3(self.velocity.x, self.velocity.y, self.velocity.z)
